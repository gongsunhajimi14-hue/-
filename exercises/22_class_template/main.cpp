...
struct Tensor4D {
    ...
    Tensor4D &operator+=(Tensor4D const &others) {
        ...
        unsigned int st_this[4] = {
            shape[1] * shape[2] * shape[3],
            shape[2] * shape[3],
            shape[3],
            1
        };
        unsigned int st_oth[4] = {
        ...
        for (unsigned int i3 = 0; i3 < shape[3]; ++i3) {
            unsigned int idx_this = i0 * st_this[0] + i1 * st_this[1] + i2 * st_this[2] + i3;
            ...
            unsigned int idx_oth = o0 * st_oth[0] + o1 * st_oth[1] + o2 * st_oth[2] + o3;

            data[idx_this] += others.data[idx_oth];
        }
        return *this;
    }
};
